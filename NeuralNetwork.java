...
public class NeuralNetwork {
	...
	// Notes:
		// THIS IS NOT FINAL - BIASES ARE NOT IMPLEMENTED, ANOTHER NEURAL NETWORK WILL BE DEVELOPED, THIS IS FOR THE MEANTIME
	    ...
	    public static void main(String[] args) {
	    	// Try to retrive expression data from ExpressionData class
	    	ExpressionData expression = new ExpressionData();
	    	System.out.println(expression.expressionData);
	        ...
	        for(int i = 0; i < tDataSet.length; i++) {
	            forward(tDataSet[i].data);
	            System.out.println(Math.round(layers[2].neurons[0].value));
	        }
	    }
	    ...
	    public static void CreateTrainingData() {
	        ...
	        float[] input5 = new float[] {0, 0}; //Expect 0 here
	        float[] input6 = new float[] {1, 0}; //Expect 1 here
	        float[] input7 = new float[] {0, 1}; //Expect 1 here
	        float[] input8 = new float[] {1, 1}; //Expect 0 here
	        ...
	        float[] expectedOutput5 = new float[] {0};
	        float[] expectedOutput6 = new float[] {1};
	        float[] expectedOutput7 = new float[] {1};
	        float[] expectedOutput8 = new float[] {0};
	        
	        // My changes (using an array for the data sets)
	        tDataSet = new TrainingData[8];
	        ...
	        tDataSet[5] = new TrainingData(input6, expectedOutput6);
	        tDataSet[6] = new TrainingData(input7, expectedOutput7);
	        tDataSet[7] = new TrainingData(input8, expectedOutput8);        
	    }
